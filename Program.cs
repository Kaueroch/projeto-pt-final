    ...
    static void Main(string[] args)
    {
...

        {
            ...
            case 3:
                ...
                Console.WriteLine("Escolheu Mega sena!!");
                Console.WriteLine("-------------------------------");
                Console.WriteLine("Venha testar sua sorte!");
                Console.WriteLine("Digite um numero!");
                n1 = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("Digite um numero!");
                n2 = Convert.ToInt32(Console.ReadLine());
                ...
                Random rnd = new Random();
                 int sorteio1 = rnd.Next(1, 100);
                int sorteio2 = rnd.Next(1, 100);
                int sorteio3 = rnd.Next(1, 100);
                int sorteio4 = rnd.Next(1, 100);
                if (n1 == sorteio1 && n2 == sorteio2 && n3 == sorteio3 && n4 == sorteio4)
                {
                    Console.WriteLine("Parabens!! Voce ganhou a mega-sena!!" + n1 + n2 + n3 + n4);
                }else{
